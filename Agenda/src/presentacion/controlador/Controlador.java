...
public class Controlador implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == this.vista.getBtnAgregar()
			...
			this.ventanaPersona = new VentanaPersona(this, localidadModel, tipoContactoModel,null);
			this.ventanaPersona.getListaLocalidades().setModel(localidadModel);
			this.ventanaPersona.getListaTipoContacto().setModel(
					tipoContactoModel);
		}
		else if (e.getSource() == this.vista.getBtnEditar() || e.getSource()==this.vista.getMntmContacto_1()) {
			int fila_seleccionada = this.vista.getTablaPersonas()
					.getSelectedRows()[0];
			PersonaDTO persona_seleccionada = this.personas_en_tabla.get(fila_seleccionada);
			...
			this.ventanaPersona = new VentanaPersona(this, localidadModel, tipoContactoModel, persona_seleccionada);
		}
		// elimina un contacto
		...
		if (this.ventanaTipoContacto != null && e.getSource() == this.ventanaTipoContacto.getBtnAgregar())
		{
		...
		//eliminar localidad y tipo de contacto
			...
			else 
			{
				...
				if(this.ventanaPersona.isEditar()==true)
				{
					...
					PersonaDTO persona_a_editar = ventanaPersona.getPersonaAEditar();


					persona_a_editar.setNombre(this.ventanaPersona.getTxtNombre().getText());
					persona_a_editar.setApellido(this.ventanaPersona.getTxtApellido().getText());
					persona_a_editar.setTelefono(this.ventanaPersona.getTextTelefono().getText());
					persona_a_editar.setMail(this.ventanaPersona.getTextMail().getText());
					persona_a_editar.setFechanac(new java.sql.Date(this.ventanaPersona.getDateChooser().getDate().getTime()));
					persona_a_editar.setCalle(this.ventanaPersona.getTextCalle().getText());
					persona_a_editar.setAltura(this.ventanaPersona.getTextAltura().getText());
					persona_a_editar.setPiso(this.ventanaPersona.getTextPiso().getText());
					persona_a_editar.setDepto(this.ventanaPersona.getTextDepto().getText());
